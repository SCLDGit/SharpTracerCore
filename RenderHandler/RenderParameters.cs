namespace RenderHandler
{
    ...
    {
        public RenderParameters(int p_xResolution, int p_yResolution, int p_numberOfSamples, int p_bounceDepth, bool p_parallel, bool p_realTimeUpdate, double p_gammaCorrection, string p_savePath, bool p_printRenderData = true)
        {
            ...
            Parallel = p_parallel;
            RealTimeUpdate = p_realTimeUpdate;
        ...
        public bool RealTimeUpdate { get; private set; }
    }
}
