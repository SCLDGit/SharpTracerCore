namespace RenderHandler
{
    ...
    {
        public RenderParameters(int p_xResolution, int p_yResolution, int p_numberOfSamples, int p_bounceDepth, double p_gammaCorrection, string p_savePath, bool p_printRenderData = true)
        {
